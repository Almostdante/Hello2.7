...
cur.execute("SELECT Original_name, Russian_name, Year, Director, IMDB_Rating, IMDB_Votes, Metascore, Subtitles, Resolution, File_size, Link, Torrent_File FROM Torrents JOIN Movies ON Movies.IMDB_ID = Torrents.MovieID WHERE Torrents.ID > ?;", (maxID, ))
